...
public class FacilitiesDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name_tv.setText(DataManager.getArcheryRanges().get(index).getName());
        district_tv.setText("District: " + DataManager.getArcheryRanges().get(index).getDistrict());
        address_tv.setText("Address: " + DataManager.getArcheryRanges().get(index).getAddress());
        num_of_courts_tv.setText("Number of Courts: " + DataManager.getArcheryRanges().get(index).getNumCourts());
        ancillary_facilities_tv.setText("Ancillary Facilities: " + DataManager.getArcheryRanges().get(index).getAncillaryFacilities());
        phone_num_tv.setText("Phone Number: " + DataManager.getArcheryRanges().get(index).getPhone());
        opening_hours_tv.setText(DataManager.getArcheryRanges().get(index).getOpeningHours());
